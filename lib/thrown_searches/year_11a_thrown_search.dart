...
class MyYear11ClassASearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyYear11ClassASearch({@required this.all});
  ...
  Future navigateToYear11ClassADetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((year11ClassA) => year11ClassA.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((year11ClassA) => year11ClassA.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          year11ClassANotifier.currentYear11ClassA = search[position];
                          navigateToYear11ClassADetailsPage(context);
                        },
