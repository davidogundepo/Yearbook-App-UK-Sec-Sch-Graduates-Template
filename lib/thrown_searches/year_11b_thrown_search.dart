...
Color textHighlightColor = Color.fromRGBO(63, 104, 124, 1.0);

var queryTech;

class MyYear11ClassBSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyYear11ClassBSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((year11ClassB) => year11ClassB.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((year11ClassB) => year11ClassB.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          year11ClassBNotifier.currentYear11ClassB = search[position];
