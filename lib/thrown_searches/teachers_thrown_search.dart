...
class MyGraduatesClassTeachersSearch extends SearchDelegate {

  final List all;

  MyGraduatesClassTeachersSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((graduatesClassTeachers) => graduatesClassTeachers.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((graduatesClassTeachers) => graduatesClassTeachers.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          graduatesClassTeachersNotifier.currentGraduatesClassTeachers = search[position];
