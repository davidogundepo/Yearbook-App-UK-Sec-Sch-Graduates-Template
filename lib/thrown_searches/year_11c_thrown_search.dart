...
class MyYear11ClassCSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyYear11ClassCSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((year11ClassC) => year11ClassC.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((year11ClassC) => year11ClassC.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          year11ClassCNotifier.currentYear11ClassC = search[position];
