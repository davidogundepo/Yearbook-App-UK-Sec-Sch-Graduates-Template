...
String dreamCollegeTitle = "Dream College\n";
...
Year11ClassCNotifier year11ClassCNotifier;
...
class Year11ClassCDetailsPage extends StatefulWidget {
  Year11ClassCDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Year11ClassCDetailsPage createState() => _Year11ClassCDetailsPage();
}

class _Year11ClassCDetailsPage extends State<Year11ClassCDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    year11ClassCNotifier = Provider.of<Year11ClassCNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            year11ClassCNotifier.currentYear11ClassC.nickname,
...
//                  ),
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: year11ClassCNotifier.currentYear11ClassC.image,
                        fit: BoxFit.cover,
                  ...
                  message: year11ClassCNotifier.currentYear11ClassC.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              year11ClassCNotifier.currentYear11ClassC.name.toUpperCase(),
                            ...
                            (() {
                              if (year11ClassCNotifier.currentYear11ClassC.prefect == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState() {
    ...
    Year11ClassCNotifier year11ClassCNotifier = Provider.of<Year11ClassCNotifier>(context, listen: false);

    _autoBio = year11ClassCNotifier.currentYear11ClassC.autoBio;
    _bestMoment = year11ClassCNotifier.currentYear11ClassC.bestMoment;
    _dob = year11ClassCNotifier.currentYear11ClassC.dob;
    _dreamCollege = year11ClassCNotifier.currentYear11ClassC.dreamCollege;
    _email = year11ClassCNotifier.currentYear11ClassC.email;
    _facebook = year11ClassCNotifier.currentYear11ClassC.facebook;
    _hobbies = year11ClassCNotifier.currentYear11ClassC.hobbies;
    _instagram = year11ClassCNotifier.currentYear11ClassC.instagram;
    _myDropline = year11ClassCNotifier.currentYear11ClassC.myDropline;
    _name = year11ClassCNotifier.currentYear11ClassC.name;
    _nickname = year11ClassCNotifier.currentYear11ClassC.nickname;
    _philosophy = year11ClassCNotifier.currentYear11ClassC.philosophy;
    _phone = year11ClassCNotifier.currentYear11ClassC.phone;
    _prefect = year11ClassCNotifier.currentYear11ClassC.prefect;
    _prefectPosition = year11ClassCNotifier.currentYear11ClassC.positionEnforced;
    _country = year11ClassCNotifier.currentYear11ClassC.constituentCountry;
    _regionFrom = year11ClassCNotifier.currentYear11ClassC.regionFrom;
    _twitter = year11ClassCNotifier.currentYear11ClassC.twitter;
    ...
    _favWatchedMovie = year11ClassCNotifier.currentYear11ClassC.favWatchedMovie;
    _worstMoment = year11ClassCNotifier.currentYear11ClassC.worstMoment;
