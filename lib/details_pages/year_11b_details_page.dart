...
String dreamCollegeTitle = "Dream College of Study\n";
...
String favSportInCampusTitle = "Favourite School Activity on Campus\n";
...
Year11ClassBNotifier year11ClassBNotifier;
...
class Year11ClassBDetailsPage extends StatefulWidget {
  Year11ClassBDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Year11ClassBDetailsPage createState() => _Year11ClassBDetailsPage();
}

class _Year11ClassBDetailsPage extends State<Year11ClassBDetailsPage> {
  ...
  Widget build(BuildContext context) {
    year11ClassBNotifier = Provider.of<Year11ClassBNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            year11ClassBNotifier.currentYear11ClassB.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: year11ClassBNotifier.currentYear11ClassB.image,
                        fit: BoxFit.cover,
                  ...
                  message: year11ClassBNotifier.currentYear11ClassB.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              year11ClassBNotifier.currentYear11ClassB.name.toUpperCase(),
                            ...
                            (() {
                              if (year11ClassBNotifier.currentYear11ClassB.prefect == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState() {
    ...
    _autoBio = year11ClassBNotifier.currentYear11ClassB.autoBio;
    _bestMoment = year11ClassBNotifier.currentYear11ClassB.bestMoment;
    _dob = year11ClassBNotifier.currentYear11ClassB.dob;
    _dreamCollege = year11ClassBNotifier.currentYear11ClassB.dreamCollege;
    _email = year11ClassBNotifier.currentYear11ClassB.email;
    _facebook = year11ClassBNotifier.currentYear11ClassB.facebook;
    _hobbies = year11ClassBNotifier.currentYear11ClassB.hobbies;
    _instagram = year11ClassBNotifier.currentYear11ClassB.instagram;
    _myDropline = year11ClassBNotifier.currentYear11ClassB.myDropline;
    _name = year11ClassBNotifier.currentYear11ClassB.name;
    _nickname = year11ClassBNotifier.currentYear11ClassB.nickname;
    _philosophy = year11ClassBNotifier.currentYear11ClassB.philosophy;
    _phone = year11ClassBNotifier.currentYear11ClassB.phone;
    _prefect = year11ClassBNotifier.currentYear11ClassB.prefect;
    _prefectPosition = year11ClassBNotifier.currentYear11ClassB.positionEnforced;
    _country = year11ClassBNotifier.currentYear11ClassB.constituentCountry;
    _regionFrom = year11ClassBNotifier.currentYear11ClassB.regionFrom;
    _twitter = year11ClassBNotifier.currentYear11ClassB.twitter;
    _snapchat = year11ClassBNotifier.currentYear11ClassB.snapchat;
    _tikTok = year11ClassBNotifier.currentYear11ClassB.tikTok;
    _favSubject = year11ClassBNotifier.currentYear11ClassB.favSubject;
    _favSchoolActivity = year11ClassBNotifier.currentYear11ClassB.favSchoolActivity;
    _favClassmate = year11ClassBNotifier.currentYear11ClassB.favClassmate;
    _favPlaceInCampus = year11ClassBNotifier.currentYear11ClassB.favPlaceInCampus;
    _favSportInCampus = year11ClassBNotifier.currentYear11ClassB.favSportInCampus;
    _favWatchedMovie = year11ClassBNotifier.currentYear11ClassB.favWatchedMovie;
    _worstMoment = year11ClassBNotifier.currentYear11ClassB.worstMoment;
    ...
    userBIO = <int, Widget>{
      ...
      1: Column(
        ...
        children: <Widget>[
          ...
          (() {
            if (_dreamCollege.toString().isNotEmpty) {
              return Padding(
                padding: const EdgeInsets.only(top: 20.0),
                child: Container(
                  child: Material(
